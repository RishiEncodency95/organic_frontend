...
export default function ResumeUploadButton({ variant = "solid" }: Props) {
  ...
  const className = variant === "solid" 
    ...
    : "inline-flex h-[46px] w-auto items-center justify-center gap-2 rounded-full border-2 border-[#0a7140] bg-white px-8 text-[15px] font-bold text-[#0a7140] shadow-sm transition-all hover:bg-[#f4fcf6] cursor-pointer";
