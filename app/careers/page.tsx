...
/* -------------------------------------------------------------------------- */
/*
  - showOpenings = true  => show job cards with data.
  - showOpenings = false => show the "No open positions at the moment" layout.
  - Add/remove jobs in allJobOpenings and the heading count updates automatically.
*/
