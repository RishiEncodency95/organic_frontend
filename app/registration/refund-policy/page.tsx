  ...
  const policySections = [
    {
      ...
      content: "<p>This Refund & Cancellation Policy governs all payments made towards Exhibition Stall Booking, Sponsorship Packages, Buyer / Seller Registration, Delegate Registration, Seminar / Conference Participation and ICOA Buyer Membership.</p>"
    },
    {
      id: "02",
      title: "General Refund Policy",
      content: "<p>All payments made to Namo Gange Wellness Pvt. Ltd. are strictly non-refundable and non-transferable. By making payment, the Participant acknowledges and agrees to this policy.</p>"
    },
    {
      id: "03",
      title: "No Refund Scenarios",
      content: "<p>No refund shall be provided under any circumstances including but not limited to: cancellation by participant, non-attendance (no-show), partial participation or early exit, change in business plans, priorities, or schedule, dissatisfaction with business outcomes or networking results.</p>"
    },
    {
      id: "04",
      title: "Event Rescheduling / Modification",
      content: "<p>The Organiser reserves the right to reschedule, modify, or change venue or format of the Event. In such cases, the registration/booking shall remain valid for the revised event and no refund shall be applicable.</p>"
    },
    {
      id: "05",
      title: "Event Cancellation by Organiser",
      content: "<p>In rare circumstances, if the Event is cancelled, the Organiser may, at its sole discretion, offer credit for future events or provide alternative participation benefits. Refunds, if any, shall be at the sole discretion of the Organiser and not a matter of right.</p>"
    },
    {
      id: "06",
      title: "Payment Errors / Duplicate Transactions",
      content: "<p>In case of duplicate payment, excess payment, or technical error during transaction, the Participant must notify within 7 (seven) days of the transaction. After verification, eligible excess amount may be adjusted or refunded.</p>"
    },
    {
      id: "07",
      title: "Refund Processing (If Applicable)",
      content: "<p>Approved refunds (if any) shall be processed within a reasonable time frame through the original mode of payment, subject to banking norms.</p>"
    },
    {
      id: "08",
      title: "Non-Transferability",
      content: "<p>Registration, booking, or membership is non-transferable. Substitution of participant is not allowed without prior written approval.</p>"
    },
    {
      id: "09",
      title: "Role of Associate Partners",
      content: "<p>ICOA and Namo Gange Trust act only as facilitation / knowledge partners. They shall not be responsible for refunds, payment disputes, or financial claims. All refund-related matters shall be handled solely by the Organiser.</p>"
    },
    {
      id: "10",
      title: "Chargebacks & Disputes",
      content: "<p>Initiating a chargeback without valid grounds shall be treated as breach of agreement. The Organiser reserves the right to suspend participation, recover dues through legal means, and initiate appropriate legal proceedings.</p>"
    },
    {
      id: "11",
      title: "Force Majeure",
      content: "<p>No refund or liability shall arise due to natural disasters, government restrictions, pandemic, or unforeseen circumstances.</p>"
    },
    {
      id: "12",
      title: "Limitation of Liability",
      content: "<p>The Organiser shall not be liable for indirect or consequential losses, business loss, missed opportunities, or damages.</p>"
    },
    {
      id: "13",
      title: "Governing Law & Jurisdiction",
      content: "<p>This Policy shall be governed by the laws of India. Subject to exclusive jurisdiction of Courts in Delhi NCR, India.</p>"
    }
  ];
