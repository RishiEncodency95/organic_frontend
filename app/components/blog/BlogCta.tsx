...
const BlogCta = () => {
  return (
    <section className="relative overflow-hidden bg-[#fbf7e9] py-6">
        ...
        <div className="flex flex-col items-center text-center gap-6 lg:flex-row lg:items-center lg:justify-between lg:text-left">
          <Reveal direction="left" className="w-full lg:max-w-xl">
            <div>
              ...
              <h2
                className="text-[22px] md:text-[26px] lg:text-[28px] font-semibold text-[#154726] mb-2 leading-[1.15] tracking-wide"
              >
