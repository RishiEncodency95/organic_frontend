        ...
        {videos.map((v, i) => (
          <Reveal key={v.title} delay={i * 100} direction={["left", "zoom", "right"][i % 3] as "left" | "zoom" | "right"}>
            <a href="#" className="group block">
              <div className="relative overflow-hidden rounded-xl aspect-[2/3] shadow-sm">
              ...
              <p
                className="text-[12px] font-bold text-[#154726] mt-2 line-clamp-2 group-hover:text-[#3b8c2a] transition-colors"
              >
                {v.title}
              </p>
            </a>
