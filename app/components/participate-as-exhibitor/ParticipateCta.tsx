          ...
          <Reveal delay={150} direction="right">
            <div className="flex flex-shrink-0 flex-wrap justify-center gap-3">
              ...
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-2 rounded-md border-2 border-[#F2B40E] px-5 py-2.5 text-[11px] font-bold uppercase tracking-wider text-[#F2B40E] transition-all duration-300 hover:bg-[#F2B40E] hover:text-[#0b2912] hover:-translate-y-0.5"
              >
                Book Your Stall
                <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
              </Link>
