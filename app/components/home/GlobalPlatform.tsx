...
const cards = [
  {
    icon: <Image src={form1} alt="Global Connections" width={90} height={90} className="object-contain" />,
    title: "GLOBAL\nCONNECTIONS",
  ...
  {
    icon: <Image src={form2} alt="International Alliances" width={120} height={120} className="object-contain" />,
    title: "INTERNATIONAL\nALLIANCES",
  ...
  {
    icon: <Image src={form3} alt="Policy & Knowledge" width={120} height={120} className="object-contain" />,
    title: "POLICY &\nKNOWLEDGE",
  ...
  {
    icon: <Image src={form4} alt="Investment & Innovation" width={130} height={130} className="object-contain" />,
    title: "INVESTMENT &\nINNOVATION",
      ...
      <div className="w-full relative z-10 flex flex-col xl:flex-row justify-between gap-4 lg:gap-4 items-center">
        ...
        <div className="w-full xl:w-[35%] flex flex-col items-center xl:items-start text-center xl:text-left relative z-20">
          ...
          <h2 className="text-[#1a3821] text-[30px] md:text-[30px] lg:text-[38px] leading-[1.2] md:leading-[1.2] font-semibold mb-4 font-poppins tracking-tight text-center xl:text-left">
            ...
            to a <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f58634] to-[#f58634]/80">Global Platform</span>
          </h2>
