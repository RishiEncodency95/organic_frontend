    ...
    <section className="relative w-full overflow-hidden bg-white h-[580px] sm:h-[480px] md:h-[555px] lg:h-[610px]  flex items-center">
      <AnimatePresence initial={false} custom={direction}>
        ...
        >
          ...
          />
          {/* Lightened dark gradient overlay so image doesn't look dull */}
      ...
      <div className="relative z-20 container mx-auto max-w-[1400px] px-6 h-full flex flex-col justify-center">
        <div className="max-w-xl text-left mt-16 md:mt-0">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Tagline Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#3b8c2a]/20 backdrop-blur-sm border border-[#3b8c2a]/50 rounded-full">
              ...
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 pt-4 pb-2">
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 rounded-2xl bg-[#3b8c2a]/30 backdrop-blur-sm border border-[#3b8c2a]/50 flex items-center justify-center">
                    <CalendarDays className="w-6 h-6 text-[#F2B40E]" />
                  </div>
                  <div className="flex flex-col text-white drop-shadow-md">
                    <div className="font-extrabold text-sm md:text-[17px] tracking-tight">
                      {slides[current].date}
                    </div>
                    <div className="text-gray-300 font-bold text-[10px] md:text-[11px] uppercase tracking-[0.15em] mt-0.5">
                      {slides[current].dateSub}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3.5">
                  <div className="w-12 h-12 rounded-2xl bg-[#F2B40E]/20 backdrop-blur-sm border border-[#F2B40E]/50 flex items-center justify-center">
                    <MapPin className="w-6 h-6 text-[#F2B40E]" />
                  </div>
                  <div className="flex flex-col text-white drop-shadow-md">
                    <div className="font-extrabold text-sm md:text-[17px] tracking-tight">
