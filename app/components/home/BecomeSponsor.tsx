...
const BecomeSponsor = () => {
  return (
    <section className="w-full bg-gradient-to-br from-[#f4fbf6] to-white relative px-2 lg:px-11 py-1 lg:py-2 overflow-hidden border-y border-gray-100 shadow-sm">
