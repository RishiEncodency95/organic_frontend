...
export default function OfficialMessageBanner({
  ...
  return (
    <section
      ...
      className="w-full bg-[#faf6ee] px-4 py-12 sm:px-6 sm:py-16 lg:px-10"
    >
          ...
          <div className="relative overflow-hidden rounded-2xl bg-[#0e1a2b] shadow-xl ring-1 ring-black/5">
            ...
            <div className="relative aspect-[16/10] w-full sm:aspect-[16/9]">
              ...
              <button
                ...
                className="absolute left-1/2 top-1/2 flex h-14 w-14 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 shadow-lg transition hover:scale-105 hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2f6b3a] focus-visible:ring-offset-2 sm:h-16 sm:w-16"
              >
                <Play className="ml-0.5 h-6 w-6 fill-[#1f4d2c] text-[#1f4d2c] sm:h-7 sm:w-7" aria-hidden="true" />
              </button>
            </div>

            {/* Control bar */}
            <div className="flex items-center gap-3 bg-[#0a1420] px-3 py-3 sm:gap-4 sm:px-4">
              <button
                type="button"
                aria-label="Play"
