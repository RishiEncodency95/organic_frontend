        ...
        <div className="w-full relative z-10">
          <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-[1fr_0.67fr_0.67fr] lg:gap-5">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[14px] font-bold text-[#1b5e20]">Approval Pending</p>
            ...
            <div className="flex flex-col w-full h-full mt-[40px]">
              <div className="relative h-full max-h-[500px] rounded-[16px] border border-[#e5e7eb] bg-gray shadow-[0_4px_20px_rgba(0,0,0,0.12)] overflow-hidden">
                {/* Coming Soon Overlay */}
                <div className="absolute inset-0 z-50 flex items-center justify-center bg-white/90 backdrop-blur-[2px]">
                  <p className="text-[20px] font-bold tracking-wide text-gray-700 uppercase">Coming Soon</p>
                </div>
