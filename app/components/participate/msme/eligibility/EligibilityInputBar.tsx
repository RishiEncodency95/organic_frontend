...
const EligibilityInputBar = () => {
  ...
  const [checkedTime, setCheckedTime] = useState("25 May 2025, 11:30 AM");
  ...
  const handleUploadAndVerify = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setIsVerified(true);
      const now = new Date();
      setCheckedTime(now.toLocaleString("en-GB", { day: "2-digit", month: "short", year: "numeric", hour: "2-digit", minute: "2-digit", hour12: true }));
    }, 1200);
  };
