...
const WHO_SHOULD_VISIT_DATA = [
  {
    id: 1,
    header: {
      titleLine1: "WHO SHOULD",
      titleLine2: "VISIT & BENEFIT?",
      subline: "ONE PLATFORM. UNLIMITED OPPORTUNITIES.",
      desc: "Bharat Organic Expo brings together a diverse ecosystem of industry leaders, innovators, buyers, and sustainable farming pioneers driving India’s organic revolution.",
    },
    cardData: [
      {
        icon: u1,
    ...
    banner: {
      brandLine1: "BE PART OF INDIA’S",
      brandLine2: "ORGANIC MOVEMENT!",
      subtext1: "Connect. Collaborate. Innovate. Grow.",
      subtext2: "The future is organic. Let’s build it together.",
      ctaText: "JOIN THE MOVEMENT. CREATE A BETTER TOMORROW.",
...
const WhoShouldVisit = () => {
  return (
    ...
    >
      <SectionContainer>
        {WHO_SHOULD_VISIT_DATA.map((section) => (
          <div key={section.id} className="relative w-full pt-2">
            ...
            <div className="relative z-10 mb-10 md:mb-14 max-w-3xl pl-4 sm:pl-8 md:pl-12">
              ...
              >
                <span className="text-[#001810] block">{section.header.titleLine1}</span>
                <span className="text-[#4B1426] block">{section.header.titleLine2}</span>
              </h2>
            ...
            <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-y-6 mt-16 md:mt-24 lg:mt-32 mb-10 md:mb-12">
              {section.cardData.map((card, idx) => {
                return (
                  <div
                    key={idx}
                    className={`px-3 py-2 flex flex-col items-center text-center group ${
                      idx !== section.cardData.length - 1 ? "lg:border-r lg:border-gray-400/50" : ""
                    }`}
                  >
            ...
            <div className="relative z-10 bg-[#eae4d3]/95 backdrop-blur-xs border border-[#d8cdb8] rounded-2xl p-4 sm:p-6 flex flex-col lg:flex-row items-center justify-between gap-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-poppins font-semibold text-base sm:text-lg md:text-xl text-[#0f381e] uppercase tracking-tight leading-tight">
                    {section.banner.brandLine1}
                  </h4>
                  <h4 className="font-poppins font-semibold text-base sm:text-lg md:text-xl text-[#0f381e] uppercase tracking-tight leading-tight">
                    {section.banner.brandLine2}
                  </h4>
                </div>
              </div>
              ...
              <div className="hidden lg:flex items-center gap-6 border-l border-gray-400/40 pl-6">
                <div className="font-inter text-xs sm:text-sm text-gray-800">
                  <p className="font-semibold text-[#0f381e] mb-0.5">
                    {section.banner.subtext1}
                  </p>
                  <p className="font-semibold text-gray-600">
                    {section.banner.subtext2}
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <span>{section.banner.ctaText}</span>
