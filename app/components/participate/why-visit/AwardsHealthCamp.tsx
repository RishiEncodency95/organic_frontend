...
const AWARDS_HEALTH_CAMP_DATA = [
  {
    id: 1,
    header: {
      badge: "VALUE BEYOND BUSINESS",
      title: "AWARDS & RECOGNITION",
      subline: "CELEBRATING EXCELLENCE. INSPIRING IMPACT.",
      desc: "Honouring innovation, leadership and impactful contributions that are shaping a healthier, sustainable and organic future.",
    },
    valueCards: [
      {
        image: t1,
