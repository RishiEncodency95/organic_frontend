...
const WHY_VISIT_MATTERS_DATA = [
  {
    id: 1,
    header: {
      title: "Why Your Visit Matters",
      subline1: "Bharat Organic Expo brings the right products, suppliers and decision-makers together,",
      subline2: "creating real opportunities for your business growth.",
    },
    cards: [
      {
        num: "01",
    ...
    banner: {
      title: "One Visit. Multiple Opportunities.",
      desc: "Save time, meet the right people and take your business to the next level.",
    },
  },
];
  ...
  return (
    <section className="pt-1 md:pt-2 pb-3 sm:pb-4 bg-[#F6F8ED] font-inter relative overflow-hidden">
      ...
      <SectionContainer className="relative z-10">
        {WHY_VISIT_MATTERS_DATA.map((section) => (
