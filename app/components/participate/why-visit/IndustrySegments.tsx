...
const INDUSTRY_SEGMENTS_DATA = [
  {
    id: 1,
    header: {
      badge: "WHAT CAN YOU SOURCE?",
      subline: "ONE EXPO • COMPLETE ECOSYSTEM",
      mainTitleLine1: "Explore ",
      segmentCount: "6",
      mainTitleLine2: " Major Industry Segments",
    },
    segments: [
      {
        num: "01",
    ...
    cta: {
      text: "EXPLORE EXHIBITOR PROFILE",
      href: "/exhibitors",
    },
  },
];
  ...
  return (
    <section className="py-3 sm:py-4 bg-white font-inter relative overflow-hidden">
      ...
      <SectionContainer className="relative z-10">
        {INDUSTRY_SEGMENTS_DATA.map((data) => (
          <React.Fragment key={data.id}>
            ...
            <div className="text-center mb-8 flex flex-col items-center justify-center">
              ...
              <h2 className="text-xl sm:text-xl md:text-2xl lg:text-[28px] font-semibold text-[#001810] uppercase leading-[1.1] font-poppins relative inline-block mb-1.5">
                {data.header.mainTitleLine1}
                <span className="text-[#1b5e20]">{data.header.segmentCount}</span>
                {data.header.mainTitleLine2}
              </h2>
            </div>
