...
const NEED_HELP_SUPPORT_DATA = [
  {
    ...
    header: {
      ...
      descLine1: "Our dedicated team is ready to assist you at every step",
      descLine2: "of your PMS application journey.",
    },
    commitment: {
      title: "OUR COMMITMENT",
      line1: "Transparent guidance. Timely support.",
      line2: "Stronger together for a sustainable future.",
    },
    waysToConnect: [
      {
        id: "c1",
    ...
    relationshipManagers: {
      ...
      descLine1: "Personalised assistance from start to finish.",
      descLine2: "Your success is our priority.",
      stats: [
        { id: "rm1", img: v1, line1: "TRUSTED", line2: "SUPPORT" },
        { id: "rm2", img: v2, line1: "EXPERT", line2: "GUIDANCE" },
        { id: "rm3", img: v3, line1: "TIMELY", line2: "ASSISTANCE" },
        { id: "rm4", img: v4, line1: "BETTER", line2: "OUTCOMES" },
      ],
    },
    bottomGreenBanner: {
      title: "TOGETHER, LET’S GROW A SUSTAINABLE INDIA",
      desc: "We look forward to supporting your journey at ",
      highlight: "Bharat Organic Expo 2027.",
    },
    bottomLightBanner: {
  ...
  return (
    <section className="pt-1 sm:pt-2 pb-6 sm:pb-8 bg-[#fafdfa] font-inter relative overflow-hidden">
      <SectionContainer className="relative z-10">
        {NEED_HELP_SUPPORT_DATA.map((data) => (
          <div key={data.id} className="w-full">
              ...
              <div className="lg:col-span-4 flex flex-col justify-between gap-4">
                <div>
                  ...
                  <p className="font-inter text-[13px] sm:text-sm md:text-[14.5px] font-medium text-[#131730] leading-relaxed">
                    <span className="block">{data.header.descLine1}</span>
                    <span className="block">{data.header.descLine2}</span>
                  </p>
                </div>
                      ...
                      <div key={col.id} className={`text-center px-1 pt-2 sm:pt-0 flex flex-col items-center ${idx !== 0 ? "sm:pl-2" : ""}`}>
                        ...
                        {col.contactHref ? (
                          <a
                            ...
                            target={col.contactHref.startsWith("http") ? "_blank" : undefined}
                            rel={col.contactHref.startsWith("http") ? "noopener noreferrer" : undefined}
                ...
                <div className="flex items-center gap-3.5 mb-4">
                  ...
                  <div>
                    ...
                    <p className="font-inter text-[13px] text-black font-medium leading-relaxed">
                      ...
                      {data.relationshipManagers.descLine2}
                    </p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 rounded-2xl overflow-hidden shadow-md border border-slate-200">
                ...
                <div>
                  ...
                  <p className="font-inter text-xs text-emerald-100 font-medium leading-tight">
                    ...
                    <span className="font-semibold text-lime-300">
                      {data.bottomGreenBanner.highlight}
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 bg-[#f4f7f4] p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 border-t lg:border-t-0 lg:border-l border-slate-200">
                ...
                <a
                  href={data.bottomLightBanner.ctaHref}
                  target="_blank"
                ...
                >
                  <span>{data.bottomLightBanner.ctaText}</span>
