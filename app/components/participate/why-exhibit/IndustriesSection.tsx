    ...
    <SectionContainer className="relative z-10">
      <div className="text-center mb-6">
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          <span className="text-[#0a092a] font-semibold text-lg md:text-xl uppercase tracking-[0.1em] font-inter">
            Industries We Serve
          </span>
          <span className="w-12 h-[2px] bg-[#1b5e20]" />
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-10 gap-3">
        {industries.map((item, i) => {
          ...
          return (
            <div
              key={i}
              className="flex flex-col items-center text-center group px-0.5 py-4 rounded-xl transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_14px_30px_rgba(0,0,0,0.11)]"
              style={{
            ...
            >
              <div className="mb-3 transition-transform group-hover:scale-110">
                <IconComponent className="w-7 h-7 text-[#c2410c] stroke-[1.75]" />
              </div>
              <div className="flex flex-col items-center justify-center min-h-[30px] w-full px-1">
                <span className="text-[10px] font-bold text-[#1b5e20] uppercase leading-tight tracking-tighter whitespace-normal font-inter">{item.line1}</span>
                <span className="text-[10px] font-bold text-[#1b5e20] uppercase leading-tight tracking-tighter whitespace-normal font-inter">{item.line2}</span>
              </div>
            </div>
          );
        })}
