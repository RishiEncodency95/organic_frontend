...
export const WHY_EPROMOTE_DATA = [
  {
    id: 1,
    leftTitle: "WHY E-PROMOTE WITH US?",
    leftDesc: "Our e-promotion solutions are designed to give your brand unmatched visibility to a highly engaged and relevant audience across multiple digital touchpoints.",
...
export default function WhyEPromote() {
  ...
  const data = WHY_EPROMOTE_DATA[0];
