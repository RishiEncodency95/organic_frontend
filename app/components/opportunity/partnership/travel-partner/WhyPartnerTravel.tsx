...
import plane2og from "@/app/assets/icons/plane2og.png";
...
export default function WhyPartnerTravel() {
  ...
  const points = [
    ...
    "Position your brand among top travel service providers",
      ...
      <SectionContainer className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 bg-[#F5F4EF] p-8 rounded-2xl border border-gray-150 flex flex-col justify-between relative overflow-hidden">
            ...
            {/* Plane Graphic Decoration */}
            <img 
              src={plane2og.src} 
              alt="Plane Decoration" 
              className="absolute right-0 bottom-0 w-40 md:w-56 object-contain pointer-events-none opacity-100" 
            />
          </div>
