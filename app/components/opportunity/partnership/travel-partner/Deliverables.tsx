...
export const DELIVERABLES_TRAVEL_DATA = [
  {
    id: 1,
    ...
    deliverables: [
      {
        iconKey: "Globe",
        title: "Logo on official travel partner section on website",
      ...
      },
      {
        ...
        desc: "Your agency profile will be listed in the official partner directory."
      },
      {
        iconKey: "Ticket",
      ...
      },
      {
        ...
        desc: "Your advertisement / travel catalog will be displayed in the official event e-brochure."
      },
      {
        iconKey: "Share2",
        title: "Social media shoutouts & tag mentions",
        desc: "Your travel agency will be promoted across our social media platforms with dedicated posts."
      },
      {
        iconKey: "Plane",
        title: "Showcase your travel & transport packages",
        desc: "Opportunity to showcase flight, cab & local tour packages to attendees."
      },
      {
        iconKey: "HeartHandshake",
        title: "Co-branding on key communications",
        desc: "Your logo will be included in select event communications as our travel partner."
      },
      {
        iconKey: "Star",
        title: "Opportunity for joint campaigns & promotions",
        desc: "Collaborate with us on special travel offers for delegates and international buyers."
      }
    ]
  }
];
...
export default function Deliverables() {
  const data = DELIVERABLES_TRAVEL_DATA[0];
