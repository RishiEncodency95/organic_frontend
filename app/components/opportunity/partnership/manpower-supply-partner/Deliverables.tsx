  ...
  const deliverables = [
    {
      ...
      text: "Logo on official manpower partner section on website",
      subtext: "Your logo will be displayed on the partner page with direct link to your website."
    },
    {
      icon: <LayoutGrid className="w-5 h-5" />,
      text: "Logo on signage & at venue (high visibility)",
      subtext: "Prominent logo placement on directional signage, welcome boards & key areas."
    },
    {
    ...
    },
    {
      ...
      text: "Showcase your services & special offers",
      subtext: "Opportunity to showcase your manpower services & exclusive offers."
    },
    {
      icon: <HeartHandshake className="w-5 h-5" />,
      text: "Co-branding on key communications",
      subtext: "Your logo will be included in select event communications as our manpower partner."
    },
    {
      icon: <Sparkles className="w-5 h-5" />,
      text: "Opportunity for joint campaigns & promotions",
      subtext: "Collaborate with us on special offers to attract more exhibitors and visitors."
    }
  ];
