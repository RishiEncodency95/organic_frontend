...
export const DELIVERABLES_MANPOWER_DATA = [
  {
    id: 1,
    ...
    deliverables: [
      {
        iconKey: "Globe",
        title: "Logo on official manpower partner section on website",
      ...
      },
      {
        ...
        desc: "Your advertisement / staffing profile will be displayed in the official event e-brochure."
      },
      {
        iconKey: "Share2",
        title: "Social media shoutouts & tag mentions",
        desc: "Your agency will be promoted across our social media platforms with dedicated posts."
      },
      {
        iconKey: "Users",
        title: "Showcase your manpower & staffing services",
        desc: "Opportunity to showcase hostesses, promoters & security staffing services."
      },
      {
        iconKey: "HeartHandshake",
        title: "Co-branding on key communications",
        desc: "Your logo will be included in select event communications as our manpower partner."
      },
      {
        iconKey: "Star",
        title: "Opportunity for joint campaigns & promotions",
        desc: "Collaborate with us on special staffing solutions to assist exhibitors."
      }
    ]
  }
];
...
export default function Deliverables() {
  const data = DELIVERABLES_MANPOWER_DATA[0];
