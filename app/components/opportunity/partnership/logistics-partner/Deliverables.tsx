  ...
  const deliverables = [
    {
      ...
      text: "Logo on official logistics partner section on website",
      subtext: "Your logo will be displayed on the\npartner page with direct link to\nyour website."
    },
    {
      icon: <LayoutGrid className="w-5 h-5" />,
      text: "Logo on signage & at venue (high visibility)",
      subtext: "Prominent logo placement on\ndirectional signage, logistics area\n& key touchpoints."
    },
    {
    ...
    },
    {
      ...
      text: "Showcase your services at logistics zone",
      subtext: "Opportunity to display branding at the logistics helpdesk / operations area."
    },
    {
      icon: <HeartHandshake className="w-5 h-5" />,
      text: "Co-branding on key communications",
      subtext: "Your logo will be included in select event promotions as our logistics partner."
    },
    {
            ...
            {deliverables.map((item, idx) => (
              ...
              >
                ...
                <div className="flex flex-col gap-0.5 pt-1 w-full">
                  ...
                  {item.subtext && (
                    <p className="text-[10px] text-gray-600 font-medium leading-snug font-inter mt-0.5 whitespace-pre-line">
                      {item.subtext}
                    </p>
                  )}
                </div>
