...
export const DELIVERABLES_LOGISTICS_DATA = [
  {
    id: 1,
    ...
    deliverables: [
      {
        iconKey: "Globe",
        title: "Logo on official logistics partner section on website",
      ...
      },
      {
        ...
        desc: "Your advertisement / service profile will be displayed in the official event e-brochure."
      },
      {
        iconKey: "Share2",
        title: "Social media shoutouts & tag mentions",
        desc: "Your logistics service will be promoted across our social media platforms with dedicated posts."
      },
      {
        iconKey: "Truck",
        title: "Showcase your logistics & transport services",
        desc: "Opportunity to showcase your transport, warehousing & handling solutions."
      },
      {
        iconKey: "HeartHandshake",
        title: "Co-branding on key communications",
        desc: "Your logo will be included in select event communications as our logistics partner."
      },
      {
        iconKey: "Star",
        title: "Opportunity for joint campaigns & promotions",
        desc: "Collaborate with us on special offers to assist exhibitors with cargo and freight."
      }
    ]
  }
];
...
export default function Deliverables() {
  const data = DELIVERABLES_LOGISTICS_DATA[0];
