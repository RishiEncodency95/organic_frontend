...
import { ArrowRight, Mail, Phone, Globe, MapPin, Truck } from "lucide-react";
import leafsImg from "@/app/assets/icons/leafs.png";
import logiog from "@/app/assets/icons/logiog.png";
import SectionContainer from "@/app/components/layout/SectionContainer";

export const WHY_PARTNER_LOGISTICS_DATA = [
  {
    id: 1,
    leftTitleLine1: "WHY PARTNER AS",
    leftTitleLine2: "LOGISTICS PARTNER?",
...
export default function WhyPartnerLogistics() {
  ...
  const data = WHY_PARTNER_LOGISTICS_DATA[0];
