...
export const PARTNERSHIP_OPPORTUNITIES_DATA = [
  {
    id: 1,
    heading: "PARTNERSHIP OPPORTUNITIES",
    subheading: "Our Partner Categories & Benefits",
    subtitle: "Choose a category that fits your business goals and unlock exclusive advantages.",
    opportunities: [
      {
        num: "01",
...
export default function PartnershipOpportunities() {
  const data = PARTNERSHIP_OPPORTUNITIES_DATA[0];
    ...
    <section className="pt-10 pb-6 bg-white font-inter relative overflow-hidden">
      ...
      <SectionContainer className="mt-8 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm font-bold text-[#ea580c]">{data.subheading}</p>
          <p className="text-[11px] text-gray-900 font-medium mt-1">{data.subtitle}</p>
        </div>
          ...
          {data.opportunities.map((opp, idx) => (
            ...
            >
              <div className="flex items-center gap-4 mb-5">
                ...
                <Image src={ICON_MAP[opp.iconKey]} alt={opp.title} width={48} height={48} className="object-contain shrink-0" />
