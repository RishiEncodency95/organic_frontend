...
import { 
  ...
  Mic, HeartHandshake, Star, Printer
} from "lucide-react";
...
export const DELIVERABLES_PRINTING_DATA = [
  {
    id: 1,
    ...
    deliverables: [
      {
        iconKey: "Globe",
        title: "Logo on official printing partner section on website",
      ...
      },
      {
        ...
        desc: "Your firm profile will be listed in the official partner directory."
      },
      {
        iconKey: "Ticket",
      ...
      },
      {
        ...
        desc: "Your advertisement / printing catalog will be displayed in the official event e-brochure."
      },
      {
        iconKey: "Share2",
        title: "Social media shoutouts & tag mentions",
        desc: "Your print services will be promoted across our social media platforms with dedicated posts."
      },
      {
        iconKey: "Printer",
        title: "Showcase your print & branding solutions",
        desc: "Opportunity to showcase your signage, lanyard, banner & printing capabilities."
      },
      {
        iconKey: "HeartHandshake",
        title: "Co-branding on key communications",
        desc: "Your logo will be included in select event communications as our printing partner."
      },
      {
        iconKey: "Star",
        title: "Opportunity for joint campaigns & promotions",
        desc: "Collaborate with us on special offers to assist exhibitors with marketing collateral."
      }
    ]
  }
];
...
export default function Deliverables() {
  const data = DELIVERABLES_PRINTING_DATA[0];
