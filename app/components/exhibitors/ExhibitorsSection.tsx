...
const ExhibitorsSection = ({ exhibitors }: ExhibitorsSectionProps) => {
    ...
    return (
        <React.Fragment>
            ...
            {/* Section Header */}
            <div className="container mx-auto max-w-[1400px] px-6 pt-6 pb-3 text-center font-inter">
                <Reveal>
            ...
            <section className="container mx-auto max-w-[1400px] px-6 pb-12 font-inter">
                <div
