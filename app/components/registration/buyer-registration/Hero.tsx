...
export default function BuyerRegistrationHero() {
    ...
    <>
      <style>{`
        ...
        .buyer-register-btn::before {
          ...
          animation: shimmerBuyer 2.5s infinite;
        }
        @keyframes gentlePulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(168,208,96,0.4); }
          50%       { box-shadow: 0 0 0 8px rgba(168,208,96,0); }
        }
        .badge-pulse { animation: gentlePulse 2.5s ease-in-out infinite; }
      `}</style>
              ...
              <div ref={ctaRef} className="flex flex-wrap items-center gap-3" style={{ opacity: 0 }}>
                <div className="relative">
                  ...
                  <a
                    ...
                    className="buyer-register-btn text-white px-6 py-3 rounded-xl font-bold text-[11px] uppercase tracking-widest flex items-center gap-2 transition-all active:scale-95 relative z-10"
                  >
