    ...
    <form onSubmit={handleSubmit} className="w-full space-y-2 animate-in fade-in duration-500">
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#4d7f1d]/20 pb-1.5 mb-4 gap-2 mt-8">
          <h3 className="text-[14px] font-bold text-[#1b5e20] uppercase tracking-wide font-poppins">
            Personal Information
          </h3>
          <span className="text-[10px] font-bold bg-[#1b5e20]/10 text-[#1b5e20] px-2 py-1 rounded tracking-widest uppercase w-fit">Step 1 of 2</span>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[#4d7f1d]/20 pb-1.5 mb-4 gap-2 mt-8">
        ...
        <span className="text-[10px] font-bold bg-[#1b5e20]/10 text-[#1b5e20] px-2 py-1 rounded tracking-widest uppercase w-fit">Step 2 of 2</span>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
