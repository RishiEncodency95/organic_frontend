...
export default function ExhibitionSectors() {
  return (
    <section className="w-full bg-[#f9f8f4] py-4 md:py-6">
      <div className="w-full px-4 md:px-14">

        {/* Section Header */}
        <div className="flex items-center justify-center mb-6 w-full overflow-hidden">
          <div className="h-[2px] w-full max-w-[100px] bg-gray-300 relative mr-4">
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-gray-400"></div>
          </div>
          <h3 className="text-[14px] md:text-[20px] font-semibold text-[#1b5e20] uppercase tracking-wide whitespace-nowrap px-4 font-poppins">
            10 MAJOR SECTORS. COMPLETE VALUE CHAIN.
          </h3>
          <div className="h-[2px] w-full max-w-[100px] bg-gray-300 relative ml-4">
