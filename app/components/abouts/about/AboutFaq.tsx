...
const AboutFaq = () => {
  ...
  return (
    <>
      ...
      />
      <section className="w-full bg-white py-2 md:py-6 lg:py-6 border-t border-gray-100">
        <div className="w-full px-4 md:px-11">

          {/* Header */}
          <div className="flex flex-col items-center text-center mb-4">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-[2px] bg-[#113d29]"></div>
        ...
        <div className="relative z-10  px-5 py-2 sm:px-8 md:py-4 lg:px-11 xl:px-16">
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="max-w-[700px]">
              ...
              {/* Heading */}
              <h2 className="max-w-[580px] text-[18px] md:text-[28px] lg:text-[32px] font-semibold leading-[1.12] tracking-tight text-[#113d29]">
                Be Part of India's{" "}
