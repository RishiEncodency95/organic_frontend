...
const organizerData = {
  ...
  journey: {
    ...
    subtitle: "With a proven legacy of delivering result-oriented exhibitions, we forge lasting business relationships and accelerate industry growth.",
    timeline: {
      title: "OUR JOURNEY: A LEGACY OF GROWTH",
      events: [
    ...
    sectors: {
      title: "DRIVING INNOVATION ACROSS CORE SECTORS",
      items: [
    ...
    flagship: {
      title: "FLAGSHIP EVENTS: A PROVEN TRACK RECORD",
      desc: "NGWPL's flagship events consistently deliver exceptional value and foster vibrant communities, creating significant market opportunities.",
      events: [
        ...
        <SectionContainer>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 divide-y lg:divide-y-0 lg:divide-x divide-gray-200 items-center">
            ...
            <div className="pt-4 lg:pt-0 lg:pr-6">
              ...
              >
                {organizerData.about.title}
              </h2>

              {organizerData.about.paragraphs.map((p, i) => (
                <p key={i} className={`text-gray-800 text-[13px] leading-[1.7] ${i === 1 ? 'mb-5' : 'mb-3'} text-justify font-semibold`}>
                  {p}
                </p>
              ))}
              ...
              <p className="text-[#23471d] font-bold text-[10px] uppercase tracking-[0.2em] mb-2">
                {organizerData.about.capabilitiesTitle}
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 mb-1">
                {organizerData.about.capabilities.map((item, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 relative z-10">
            ...
            <div className="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-xl p-5 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-[#23471d] font-bold text-[12px] uppercase tracking-[0.12em]">
                  {organizerData.journey.timeline.title}
                </p>
              </div>

              <div className="flex flex-col gap-4 pl-3 border-l-2 border-[#d26019]/25">
                {organizerData.journey.timeline.events.map((item, i) => (
            ...
            <div className="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-xl p-5 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-[#23471d] font-bold text-[12px] uppercase tracking-[0.12em]">
                  {organizerData.journey.sectors.title}
                </p>
              </div>

              <div className="flex flex-col gap-3">
                {organizerData.journey.sectors.items.map((item, i) => (
            ...
            <div className="bg-white/95 backdrop-blur-sm border border-gray-200 rounded-xl p-5 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-[#23471d] font-bold text-[12px] uppercase tracking-[0.12em]">
                  {organizerData.journey.flagship.title}
                </p>
              </div>

              <p className="text-gray-600 text-[13px] leading-[1.6] mb-3">
                {organizerData.journey.flagship.desc}
              </p>

              <div className="flex flex-col gap-2">
                {organizerData.journey.flagship.events.map((ev, i) => (
