...
const aboutVenueData = {
  tagline: "OUR VENUE",
  title: "Why Pragati Maidan, New Delhi?",
  hallBadge: "Hall 12",
  locationBadge: "Pragati Maidan, New Delhi",
  features: [
    {
      color: "#d26019",
      bg: "#fff3eb",
          ...
          <div className="relative overflow-hidden group rounded-xl shadow-md border border-gray-200">
            <div className="relative w-full h-[260px] md:h-[340px]">
              <Image
                ...
                alt={aboutVenueData.locationBadge}
                fill
