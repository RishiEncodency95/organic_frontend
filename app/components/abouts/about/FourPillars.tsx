...
const FourPillars = () => {
  return (
    <section className="w-full bg-white py-2 md:py-6 lg:py-6">
      <div className="w-full px-4 md:px-11">
        <h3 className="text-center text-[22px] md:text-[25px] lg:text-[25px] font-semibold text-[#113d29] leading-[1.2] mb-6">
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className={`pt-8 pb-4 px-4 flex flex-col flex-1 ${pillar.imageBg}`}>
                <h3
                  className="text-[18px] md:text-[20px] font-semibold uppercase tracking-wide leading-[1.3] mb-3 text-center"
