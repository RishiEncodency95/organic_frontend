            ...
            <div className="relative z-10 w-full px-4 md:px-11">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-6 xl:gap-10">
                    ...
                    <div className="w-full lg:w-[45%] flex flex-col justify-center">
                        ...
                        {/* Heading */}
                        <h3 className="text-[#1f471b] font-semibold text-[24px] sm:text-[26px] lg:text-[26px]  leading-[1.1] mb-4">
                        ...
                        <div className="relative bg-white rounded-3xl p-2 sm:p-4 lg:px-4 lg:py-4 w-full max-w-[350px] transform transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(59,140,42,0.15)] shadow-[0_10px_30px_rgba(0,0,0,0.06)] border border-gray-100 border-b-[6px] border-r-[4px] border-b-[#3b8c2a]/20 border-r-[#3b8c2a]/10">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <div className="relative w-11 h-11 flex items-center justify-center group">
                                    ...
                                    <Eye size={22} strokeWidth={2.5} className="text-[#3b8c2a] relative z-10 drop-shadow-sm" />
                                </div>
                            ...
                            {/* Card Content */}
                            <p className="text-[#4a4a4a] font-medium text-[14px] lg:text-[16px] leading-[1.4] pb-4 relative z-10">
