...
export const metadata: Metadata = {
    ...
    description: "The Buyer-Seller Meet at Bharat Bharat Organic Expo 2027 brings together serious buyers and quality suppliers from the organic, natural and sustainable industry ecosystem. Register as a buyer or exhibitor today.",
    alternates: {
