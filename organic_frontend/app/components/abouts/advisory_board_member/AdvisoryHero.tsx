    ...
    features: [
        {
            icon: Users,
            titlePart1: "LEADING",
            titlePart2: "VISIONARIES",
            descPart1: "From diverse",
            descPart2: "industries"
        },
        {
            icon: Award,
            titlePart1: "STRATEGIC",
            titlePart2: "GUIDANCE",
            descPart1: "For sustainable",
            descPart2: "growth"
        },
        {
            icon: Lightbulb,
            ...
            descPart1: "Driving innovation",
            descPart2: "& impact"
        },
        {
            icon: Handshake,
            titlePart1: "COLLABORATIVE",
            titlePart2: "LEADERSHIP",
            descPart1: "Building a stronger",
            descPart2: "organic ecosystem"
        }
    ]
};
                ...
                <div className="max-w-3xl text-left mt-4 md:mt-0 space-y-4 md:space-y-6 w-full relative z-10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-[12px] sm:text-[14px] md:text-[16px] tracking-widest uppercase">
                            <span className="text-[#1b5e20]">{advisoryHeroData.subtitlePart1}</span>
                            <span className="text-[#ea580c]">{advisoryHeroData.subtitlePart2}</span>
                        </span>
                        <div className="w-8 md:w-16 h-0.5 bg-[#1b5e20]"></div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap sm:flex-nowrap justify-between gap-4 sm:gap-2 mt-6 px-4 py-2 sm:px-5 rounded-2xl bg-[#f4f7f2]/90 backdrop-blur-sm border border-[#e5ece3] shadow-sm max-w-[700px]">
                        {advisoryHeroData.features.map((feature, i) => {
                            const IconComponent = feature.icon;
                            return (
                                <div key={i} className={`flex items-start gap-3 w-full sm:w-[24%] ${i !== advisoryHeroData.features.length - 1 ? 'border-b sm:border-b-0 sm:border-r border-[#d1dcd0] pb-3 sm:pb-0 sm:pr-2' : ''}`}>
                                    ...
                                    <div>
                                        <h4 className="text-[#1b5e20] font-bold text-[11px] md:text-[12px] leading-tight mb-1">{feature.titlePart1}<br />{feature.titlePart2}</h4>
                                        <p className="text-[#555] text-[10px] md:text-[11px] leading-tight font-medium">{feature.descPart1}<br />{feature.descPart2}</p>
                                    </div>
                                </div>
                            );
                        })}
