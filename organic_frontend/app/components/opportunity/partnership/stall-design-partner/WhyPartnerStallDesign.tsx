...
import stallog from "@/app/assets/icons/stallog.png";
import leafsImg from "@/app/assets/icons/leafs.png";
import SectionContainer from "@/app/components/layout/SectionContainer";

export default function WhyPartnerStallDesign() {
  const [stateVal, setStateVal] = useState("");
  const [categoryVal, setCategoryVal] = useState("Stall Design & Manufacture Partner");
  const [agreed, setAgreed] = useState(false);

  const points = [
    "Reach a targeted audience of exhibitors and industry leaders",
    "Showcase your design excellence to top brands",
    "Build long-term relationships with exhibition participants",
      ...
      <SectionContainer className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-4 bg-[#F5F4EF] p-8 rounded-2xl border border-gray-150 flex flex-col justify-between relative overflow-hidden">
            <div>
              <h3 className="text-base md:text-lg lg:text-[17px] xl:text-[19px] whitespace-normal md:whitespace-nowrap font-semibold text-[#1b5e20] uppercase font-poppins mb-6 leading-tight">
                WHY PARTNER AS STALL DESIGN &<br className="hidden lg:block"/> MANUFACTURE PARTNER?
              </h3>
            ...
            <img 
              src={stallog.src} 
              alt="Decoration" 
              className="absolute right-0 bottom-0 w-40 md:w-56 object-contain pointer-events-none opacity-100 mix-blend-multiply" 
            />
          </div>
